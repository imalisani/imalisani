...
const steps=[
  ...
  {n:"06",tone:"lime",es:{short:"Automatización + Allure",phase:"EJECUTAR",title:"Automatización según el tipo de cambio",copy:"Si la tarea es automatizable —por ejemplo, una API— invoco el agente correspondiente, indico el ambiente desplegado y genero y ejecuto los casos. El resultado incluye reporte Allure, resumen y evidencia.",result:"Ejecución automática + Allure"},en:{short:"Automation + Allure",phase:"EXECUTE",title:"Automation based on the change type",copy:"If the task can be automated—for example, an API—I invoke the right agent, provide the deployed environment, then generate and run the cases. The result includes an Allure report, summary and evidence.",result:"Automated execution + Allure"}},
